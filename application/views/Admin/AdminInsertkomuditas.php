          ...
          <!-- Content Row -->
            ...
            <div class="card shadow">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary" align="center">Input Data Komoditas Daerah Istimewa Yogyakarta</h6>
                  
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <table align="center"><tr><td>
                  <form action="<?php echo base_url().'index.php/Admin/insertData'; ?>" method="POST">
                      <table align="center">
                        <tr>
                          <td>Wilayah</td>
                          <td>:</td>
                        ...
                        <tr>
                          <td>Tahun</td>
                          <td>:</td>
                          <td colspan="9"><input type="number" name="year" class="form-control form-control-user" placeholder="Enter year... "></td>
                        </tr>
                        <tr>
                          <td>Luas Lahan Tanam</td>
                          <td>:</td>
                          <td colspan="9"><input type="number" name="LLT" class="form-control form-control-user" placeholder="Enter data... "></td>
                        </tr>
                        <tr>
                          <td>Luas Aktivitas Tanam</td>
                          <td>:</td>
                          <td colspan="9"><input type="number" name="LAT" class="form-control form-control-user" placeholder="Enter data... "></td>
                        </tr>
                        <tr>
                          <td>Jumlah Produktivitas</td>
                          <td>:</td>
                          <td colspan="9"><input type="number" name="JP" class="form-control form-control-user" placeholder="Enter data... "></td>
                        </tr>
                        <tr>
                          <td>Rata Rata Produktivitas Produk</td>
                          <td>:</td>
                          <td colspan="9"><input type="number" name="RRPP" class="form-control form-control-user" placeholder="Enter data... "></td>
                        </tr>
                        <tr>
                          <td>Rata Rata Produktivitas Lahan</td>
                          <td>:</td>
                          <td colspan="9"><input type="number" name="RRPL" class="form-control form-control-user" placeholder="Enter data... "></td>
                        </tr>
                        <tr>
