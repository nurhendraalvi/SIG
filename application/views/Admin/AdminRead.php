                ...
                <div class="card-body">
                    <table align="center"><tr><td>
                    		<form method="POST">
                    			<table>
                    				<tr>
                    					...
                    					<td>
                    						<select id="inputState" class="form-control" name="id_jenis">
                                <?php 
                    	...
                    	if (isset($_POST['submit'])) {
                    		...
                    		$thn = $_POST['tahun'];
                    			$data=$this->db->query("SELECT a.*, b.*, c.*, d.* FROM t_kmd a inner join t_kecamatan b on a.ID = b.ID inner join t_wilayah c on c.Id_Wilayah = a.Id_Wilayah inner join t_jenis d on d.Id_Jenis = a.Id_Jenis where a.Id_Wilayah = '$wil' and Tahun='$thn' and a.Id_Jenis='$jenis'")->result();
                    			?>
                            ...
                            <?php 
                              ...
                              ?>
                            <h3 align="center"><?php echo "Kecamatan di ".$kota[0]." Tahun ".$thn." dengan Komoditas ".$JN[0]; ?></h3>

                    				<table align="center" class="table table-bordered" id="datatables" width="100%" cellspacing="0">
                    				<tr>
                    					<th>Kecamatan</th>
                    					<th>Tahun</th>
                    					<th>Luas Lahan Tanam</th>
                    					<th>Luas Aktivitas Tanam</th>
                    					<th>Jumlah Produktivitas</th>
                    					<th>Rata Rata Produktivitas Produk</th>
                    					<th>Rata Rata Produktivitas Lahan</th>
                              <th>Keterangan</th>
                    				</tr>
                    				<?php 
                    					foreach ($data as $key) {
                    					...
                    					<tr>
                    						...
                    						<td><?php echo $key->Luas_Lahan_Tanam;?></td>
                    						<td><?php echo $key->Luas_Aktivitas_Tanam;?></td>
                    						<td><?php echo $key->Jumlah_Produktivitas;?></td>
                    						<td><?php echo $key->Rata_Rata_Produktivitas_Produk;?></td>
                    						<td><?php echo $key->Rata_Rata_Produktivitas_Lahan;?></td>
                                <td>
                                <a href="<?php echo base_url().'index.php/Admin/DeleteData/'.$key->ID.'/'.$key->Id_Jenis.'/'.$key->Tahun;?>" class="btn btn-info btn-user btn-block">Hapus Data</a>
                                <a href="<?php echo base_url().'index.php/Admin/EditData/'.$key->ID.'/'.$key->Id_Jenis.'/'.$key->Tahun;?>" class="btn btn-info btn-user btn-block">Ubah Data</a>
                              </td>
                    					</tr>
                    				<?php	
                    					}
