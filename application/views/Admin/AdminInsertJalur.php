          ...
          <!-- Content Row -->
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url().'index.php/Admin/insertData2'; ?>" method="POST">
                      <table align="center">
                        <tr>
                          <td>Pelaku Pasar</td>
                          <td>:</td>
                          <td colspan="9">
                            <select id="inputState" class="form-control" name="aktor">
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td colspan="9">
                              <select id="inputState" class="form-control" name="asal">
                                <option>Pilih.....</option>
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td colspan="9">
                              <select id="inputState" class="form-control" name="tujuan">
                                <option>Pilih.....</option>
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td colspan="9">
                            <select id="inputState" class="form-control" name="komoditas">
                                <option>Pilih.....</option>
                        ...
                        <tr>
                          <td>Volume Produksi</td>
                          <td>:</td>
                          <td colspan="9"><input type="number" name="jml" class="form-control form-control-user" placeholder="Enter total distribution... "></td>
                        </tr>
                        <tr>
                          <td>Prosentase Pengiriman</td>
                          <td>:</td>
                          <td colspan="9"><input type="number" name="prosentase" class="form-control form-control-user" placeholder="Enter total distribution... "></td>
                        </tr>
                        <tr>
